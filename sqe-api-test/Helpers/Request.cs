...
public static class Request
{
	...
	public static async Task<string> GetJwtViaHttpAsync(
			HttpClient        client
			, UserAuthDetails userAuthDetails = null)
	{
		...
		var (response, msg) = (loginRequest.HttpResponseMessage, loginRequest.HttpResponseObject);
	...
	/// <returns>A valid JWT</returns>
	public static async Task<string> GetJwtViaRealtimeAsync(
	...
	{
		public static readonly UserAuthDetails User1 = new()
		{
				Email = "test@1.com"
				, Password = "test"
				,
		...
		public static readonly UserAuthDetails User2 = new()
		{
				Email = "test@2.com"
				, Password = "test"
				,
