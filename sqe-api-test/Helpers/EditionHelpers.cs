...
namespace SQE.ApiTest.Helpers
{
    public static class EditionHelpers
    {
        ...
        /*
			...
			GROUP BY edition_id
			HAVING COUNT(DISTINCT manuscript_to_text_fragment_id) > 3 AND COUNT(DISTINCT artefact_shape_id) > 2
		 */
        private static readonly uint[] usableEditionIds =
        {
            1, 3, 22, 66, 67, 72, 76, 78, 80, 83, 86, 87, 89, 90, 93, 94, 95, 96, 98, 100, 102, 103, 104, 106, 107, 108,
            109, 111, 114, 115, 116, 117, 120, 121, 122, 123, 124, 125, 128, 129, 130, 131, 132, 133, 134, 136, 137, 140,
            141, 142, 144, 148, 149, 150, 154, 155, 156, 157, 158, 160, 165, 166, 167, 171, 209, 210, 213, 216, 217, 218,
            219, 220, 221, 226, 227, 228, 230, 231, 232, 233, 234, 235, 240, 242, 243, 244, 245, 246, 247, 248, 256, 257,
            258, 259, 260, 265, 269, 270, 271, 272, 273, 274, 280, 282, 293, 294, 298, 308, 323, 324, 326, 327, 328, 329,
            331, 332, 334, 337, 338, 339, 340, 341, 342, 343, 345, 346, 349, 350, 351, 352, 354, 355, 356, 357, 358, 359,
            361, 362, 363, 365, 366, 367, 368, 369, 370, 371, 373, 374, 375, 377, 379, 380, 381, 382, 383, 387, 388, 389,
            390, 391, 392, 393, 394, 395, 396, 397, 400, 403, 404, 406, 407, 409, 414, 430, 432, 433, 434, 435, 436, 470,
            481, 483, 493, 495, 496, 502, 509, 511, 513, 515, 519, 521, 522, 524, 525, 526, 528, 529, 530, 531, 532, 533,
            534, 535, 536, 541, 542, 544, 545, 547, 548, 550, 552, 553, 554, 556, 557, 558, 568, 569, 570, 573, 575, 576,
            578, 579, 587, 593, 596, 597, 615, 616, 617, 622, 623, 625, 630, 631, 632, 633, 634, 637, 641, 643, 644, 645,
            646, 647, 648, 650, 651, 653, 655, 657, 661, 720, 728, 743, 760, 806, 810, 819, 820, 830, 833, 838, 839, 842,
            848, 849, 850, 852, 853, 856, 859, 861, 862, 863, 864, 865, 868, 871, 873, 874, 875, 876, 877, 878, 879, 882,
            884, 885, 888, 890, 891, 894, 897, 898, 899, 900, 901, 902, 903, 904, 905, 918, 920, 923, 926, 927, 928, 930,
            932, 933, 934, 935, 936, 937, 939, 941, 944, 956, 957, 960, 963, 964, 968, 969, 970, 972, 1014, 1017, 1019,
            1022, 1023, 1024, 1028, 1029, 1034, 1035, 1042, 1050
        };
