	...
	public partial class WebControllerTest
	{
						...
						, bool                    realtime      = false)
		{
			...
			var (httpMessage, httpBody, signalr, listener) = (
					...
					, createApiRequest.SignalrResponseObject
						...
						, bool                    realtime      = false)
		{
			...
			var (httpMessage, httpBody, signalr, listener) = (
					...
					, updateApiRequest.SignalrResponseObject
						...
						, bool                    realtime      = false)
		{
			...
			var (httpMessage, httpBody, signalr, listener) = (
					...
					, deleteApiRequest.SignalrResponseObject
					, deleteApiRequest.DeletedArtefactGroup);
			...
			if (shouldSucceed)
			{
				...
				Assert.Contains(
						deleteApiRequest.DeletedArtefactGroup.ids
						, x => x == artefactGroupId);
			}
		...
		public async Task CanCreateAndDeleteArtefactGroups(bool realtime)
		{
					...
					new EditionHelpers.EditionCreator(_client, StartConnectionAsync))
			{
				 ...
				 */
				await _deleteArtefactGroupAsync(
						editionId
