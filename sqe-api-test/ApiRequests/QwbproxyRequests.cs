...
public static partial class Get
{
			...
			RequestObject<EmptyInput, QwbWordVariantListDTO>
	{
		...
		/// <returns></returns>
		public V1_QwbProxy_Words_QwbWordId_WordVariants(uint qwbWordId) => _qwbWordId = qwbWordId;
			...
			RequestObject<EmptyInput, QwbParallelListDTO>
	{
		...
		protected override string HttpPath() => RequestPath
												.Replace(
														...
														, $"/{
															HttpUtility.UrlEncode(
																	_qwbStartWordId.ToString())
														}")
												.Replace(
														"/qwb-end-word-id"
														, $"/{
															HttpUtility.UrlEncode(
																	_qwbEndWordId.ToString())
														}");
			...
			RequestObject<EmptyInput, QwbBibliographyEntryDTO>
	{
		...
		public override Func<HubConnection, Task<T>> SignalrRequest<T>()
		{
			return signalR => signalR.InvokeAsync<T>(SignalrRequestString(), _qwbBibliographyId);
		}
	}
}
