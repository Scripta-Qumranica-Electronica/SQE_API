...
public static partial class Get
{
	...
	public class V1_Editions_EditorInvitations : RequestObject<EmptyInput, EditorInvitationListDTO>
	{
		protected override string HttpPath() => RequestPath;
	...
	public class V1_Editions : RequestObject<EmptyInput, EditionListDTO>
	{
		...
		public override Func<HubConnection, Task<T>> SignalrRequest<T>()
		{
			return signalR => signalR.InvokeAsync<T>(SignalrRequestString(), _published, _personal);
		}
	}
	...
	public class V1_Manuscripts_ManuscriptId_Editions : RequestObject<EmptyInput, EditionListDTO>
	{
