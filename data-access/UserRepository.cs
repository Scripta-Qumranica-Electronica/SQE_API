...
namespace SQE.SqeHttpApi.DataAccess
{
	public interface IUserRepository
	{
		...
		Task<DetailedUserWithToken> CreateNewUserAsync(string email,
			string password,
	...
	public class UserRepository : DbConnectionBase, IUserRepository
	{
		...
		/// </returns>
		public async Task<DetailedUserWithToken> CreateNewUserAsync(string email,
			string password,
			string forename = null,
			string surname = null,
			string organization = null)
			...
			return await DatabaseCommunicationRetryPolicy.ExecuteRetry(
				async () =>
				{
					...
					using (var connection = OpenConnection())
					{
						...
						{
						} // Suppress errors here. We don't want to risk people fishing for valid email addresses,
