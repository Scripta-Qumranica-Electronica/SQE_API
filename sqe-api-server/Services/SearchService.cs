...
public class SearchService : ISearchService
{
			...
			, DetailedSearchRequestDTO request)
	{
		...
		var artefacts = new ExtendedArtefactListDTO { artefacts = new List<ExtendedArtefactDTO>() };
		...
		{
			foreach (var artDesignation in request.artefactDesignation.Where(artDesignation
																					 => !string
																							 .IsNullOrEmpty(
																									 artDesignation)))
			{
				...
				foreach (var editionArtefact in editionArtefacts)
				{
					...
					artefacts.artefacts.Add(
							new ExtendedArtefactDTO
							{
									...
									, artefactMaskEditorId = artInfo.artefactMaskEditorId
		...
		{
			foreach (var textReference in request.textReference.Where(textReference
																			  => !string
																					  .IsNullOrEmpty(
																							  textReference)))
			{
