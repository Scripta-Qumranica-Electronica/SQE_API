...
public partial class MainHub
{
	...
	[AllowAnonymous]
	public async Task<CatalogueMatchListDTO> GetV1CatalogueImagedObjectsImagedObjectIdTextFragments(
	...
	[AllowAnonymous]
	public async Task<CatalogueMatchListDTO> GetV1CatalogueTextFragmentsTextFragmentIdImagedObjects(
			uint textFragmentId)
	...
	[AllowAnonymous]
	public async Task<CatalogueMatchListDTO>
			GetV1CatalogueManuscriptsManuscriptIdImagedObjectTextFragmentMatches(uint manuscriptId)
