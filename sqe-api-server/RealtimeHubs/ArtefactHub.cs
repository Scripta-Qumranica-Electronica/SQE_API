...
namespace SQE.API.Server.RealtimeHubs
{
	public partial class MainHub : Hub
	{
		...
		[AllowAnonymous]
		public async Task<ArtefactDTO> GetV1EditionsEditionIdArtefactsArtefactId(uint artefactId,
			uint editionId,
		...
		/// <param name="editionId">Unique Id of the desired edition</param>
		[AllowAnonymous]
		public async Task<InterpretationRoiDTOList> GetV1EditionsEditionIdArtefactsArtefactIdRois(uint artefactId,
			uint editionId)
		{
		...
		/// <param name="artefactId">Unique Id of the desired artefact</param>
		[AllowAnonymous]
		public async Task<TextFragmentDataListDTO> GetV1EditionsEditionIdArtefactsArtefactIdSuggestedTextFragments(
			uint editionId,
			uint artefactId)
		{
		...
		[Authorize]
		public async Task<ArtefactDTO> PutV1EditionsEditionIdArtefactsArtefactId(uint artefactId,
			uint editionId,
