...
public static partial class ExtensionsDTO
{
	...
	public static PermissionDTO ToDTO(this Permission model) => new()
	{
	...
	public static TextFragmentSearchResponseDTO ToDTO(this TextFragmentSearch tfs) => new()
	{
	...
	public static TextFragmentSearchResponseListDTO ToDTO(this IEnumerable<TextFragmentSearch> tfsl)
		=> new() { textFragments = tfsl.Select(x => x.ToDTO()).ToList() };

	public static EditionManuscriptMetadataDTO ToDTO(this EditionMetadata em) => new()
	{
