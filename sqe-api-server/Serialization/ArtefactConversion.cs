...
{
	public static ArtefactDTO ToDTO(this ArtefactModel artefact, uint editionId) => new()
	{
	...
	{
		return new ArtefactGroupListDTO { artefactGroups = agl.Select(x => x.ToDTO()).ToList() };
	}

	public static ArtefactGroupDTO ToDTO(this ArtefactGroup ag) => new()
	{
