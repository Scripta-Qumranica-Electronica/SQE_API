...
public static partial class ExtensionsDTO
{
		...
		return new AttributeListDTO
		{
				attributes = attributes.GroupBy(
											   ...
											   , attr => new AttributeValueDTO
											   {
													   ...
													   , description =
															   attr.AttributeStringValueDescription
			...
			, IEnumerable<SignInterpretationCommentaryData> comms)
	{
		return new InterpretationAttributeDTO
		{
				...
				, commentary = comms
							   .Where(y => y.AttributeId.HasValue
										   && (y.AttributeId.Value
	...
	public static InterpretationRoiDTO ToDTO(this SignInterpretationRoiData sr) => new()
	{
	...
	public static NextSignInterpretationDTO ToDTO(this NextSignInterpretation nsi) => new()
	{
	...
	public static CommentaryDTO ToDTO(this SignInterpretationCommentaryData sic) => new()
	{
	...
	{
		return attr.Select(x => new SignInterpretationAttributeData
				   {
			...
			this SignInterpretationCreateDTO sicd)
	{
		var response = sicd.attributes == null
				...
				: sicd.attributes.Select(x => new SignInterpretationCommentaryData
					  {
							  AttributeId = x.attributeId
	...
	{
		return rois.Select(x => new SignInterpretationRoiData
				   {
	...
	public static SignInterpretationData
			ToSignInterpretationData(this SignInterpretationCreateDTO sicd) => new()
	{
	...
	public static SignData ToSignData(this SignInterpretationCreateDTO sicd) => new()
	{
			SignId = null
			, SignInterpretations =
					new List<SignInterpretationData> { sicd.ToSignInterpretationData() }
			,
	};
}
