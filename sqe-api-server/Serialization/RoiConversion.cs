...
public static partial class ExtensionsDTO
{
	public static SignInterpretationRoiData
			ToSignInterpretationRoiData(this SetInterpretationRoiDTO x) => new()
	{
	...
	public static SignInterpretationRoiData
			ToSignInterpretationRoiData(this UpdateInterpretationRoiDTO x) => new()
	{
			SignInterpretationId = x.signInterpretationId
	...
	public static UpdatedInterpretationRoiDTO ToUpdateDTO(this SignInterpretationRoiData x) => new()
	{
	...
	public static UpdateInterpretationRoiDTO
			ToUpdateInterpretationRoiDTO(this SetInterpretationRoiDTO x, uint roiId) => new()
	{
			artefactId = x.artefactId
	...
	public static Dictionary<uint, ReconstructedRoi> toModel(
			this Dictionary<uint, SetReconstructedInterpretationRoiDTO> dict) => dict.ToDictionary(
			x => x.Key
