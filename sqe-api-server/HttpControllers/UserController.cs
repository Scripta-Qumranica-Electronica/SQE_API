...
namespace SQE.API.Server.HttpControllers
{
	...
	public class UserController : ControllerBase
	{
		...
		public async Task<ActionResult<DetailedUserTokenDTO>> AuthenticateAsync(
		...
		public async Task<ActionResult> ChangeForgottenPassword(
				[FromBody] ResetForgottenUserPasswordRequestDTO payload)
		...
		public async Task<ActionResult> ChangePassword(
				[FromBody] ResetLoggedInUserPasswordRequestDTO payload)
		...
		public async Task<ActionResult<DetailedUserDTO>> ChangeUserInfo(
				[FromBody] UserUpdateRequestDTO payload) => await _userService.UpdateUserAsync(
				_userService.GetCurrentUserId()
				, payload);
		...
		public async Task<ActionResult> ForgotPassword(
				[FromBody] ResetUserPasswordRequestDTO payload)
