...
namespace SQE.API.Server.HttpControllers
{
	...
	public class CatalogueController : ControllerBase
	{
		...
		public async Task<ActionResult<CatalogueMatchListDTO>>
				GetImagedObjectsAndTextFragmentsOfEdition([FromRoute] uint editionId)
		...
		public async Task<ActionResult<CatalogueMatchListDTO>>
				GetImagedObjectsAndTextFragmentsOfManuscript([FromRoute] uint manuscriptId)
		...
		public async Task<ActionResult> PostNewImagedObjectTextFragmentMatch(
				[FromBody] CatalogueMatchInputDTO newMatch)
