...
public class EditionController : ControllerBase
{
	...
	public async Task<ActionResult> RequestAddEditionEditor(
			...
			, [FromBody] InviteEditorDTO payload) => await _editionService.RequestNewEditionEditor(
	...
	public async Task<ActionResult<EditionListDTO>> ListEditions(
			[FromQuery(Name = "published")]  bool? published
			, [FromQuery(Name = "personal")] bool? personal)
		=> await _editionService.ListEditionsAsync(
