...
public class SignInterpretationSequence
{
	...
	public SignInterpretationSequence createNewSequence(SignInterpretation addedSignInterpretation)
	{
	...
	public uint GetSignInterpretationIdAtPosition(int position) => signInterpretationIds[position];
