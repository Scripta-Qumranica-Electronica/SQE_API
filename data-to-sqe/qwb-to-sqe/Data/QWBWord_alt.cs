...
namespace qwb_to_sqe
{
    ...
    public class QwbWord : Word
    {
                    ...
                    if (NormalSignsRegex.IsMatch(signChar.ToString()))
                        ...
                        switch (signChar)
                        {
                            ...
                            case '\u05BE': // Single destroyed sign
                                if (currSign == null) currSign = addSign(' ');
                            ...
                            case ')':
                                ...
                                break;
                            case '?':
                                if (currSign != null) currSign.IsQuestionable = true;
                                break;
                            case '|':
                            ...
                            case '┓':
                                ...
                                break;
                            default:
                                Console.WriteLine(signChar + "=" + qwbId + ": " + Word + " = '" + normalizedWord + "'");
                                break;
                        }
            }
        }
        ...
        private void ProcessReference()
        {
            ...
            if (!Fragment.StartsWith("fr")) Fragment = "col. " + Fragment;
