...
or send a letter to Creative Commons, PO Box 1866, Mountain View, CA 94042, USA.";
		...
		/// <param name="editors">
		///  An optional list of editors that can be used to automatically
		///  generate a list of contributors if the contributors variable is null.
		/// </param>
		/// <returns>A formatted license statement</returns>
		public static string printLicence(
				string                    copyrightHolder
				, string                  contributors
				, IEnumerable<EditorInfo> editors = null)
		{
...

{
	licenceText
		...
		private static string FormatEditorName(EditorInfo editor)
			=> $@"{editor.Forename} {editor.Surname}".Trim();
