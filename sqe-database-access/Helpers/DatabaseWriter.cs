...
namespace SQE.DatabaseAccess.Helpers
{
    ...
    public class MutationRequest
    {
        ...
        public MutationRequest(MutateType action,
    ...
    public class DatabaseWriter : DbConnectionBase, IDatabaseWriter
    {
        ...
        /// <returns></returns>
        private static async Task InsertOwnerTableAsync(IDbConnection connection,
            MutationRequest mutationRequest,
            uint insertId)
        {
            // Format query
        ...
        /// <returns></returns>
        private static async Task AddSingleActionAsync(IDbConnection connection,
            MutationRequest mutationRequest,
            SingleAction action)
        {
            // Format query
