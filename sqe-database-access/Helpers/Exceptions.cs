...
public static class StandardExceptions
{
	...
	public class EmailNotSentException : ServerErrorException
	{
		...
		public EmailNotSentException(string email) => Error = customMsg.Replace("$Email", email);
	}
	...
	public class NoReadPermissionsException : ForbiddenDataAccessException
	{
		...
		public NoReadPermissionsException(UserInfo editionUser) => Error = customMsg
																		   .Replace(
																				   "$UserId"
																				   , editionUser
																					 .userId
	...
	public class NoLockPermissionsException : ForbiddenDataAccessException
	{
		...
		public NoLockPermissionsException(UserInfo editionUser) => Error = customMsg
																		   .Replace(
																				   "$UserId"
																				   , editionUser
																					 .userId
	...
	public class DataNotWrittenException : ServerErrorException
	{
		...
		public DataNotWrittenException(string operation, string reason = null) => Error = customMsg
																						  .Replace(
																								  "$Operation"
																								  , operation)
																						  .Replace(
