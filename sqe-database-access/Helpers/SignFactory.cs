...
public static class SignFactory
{
	...
	public static SignData CreateSpaceSign(float width = 1, float? probability = null) => new()
	{
			SignInterpretations = new List<SignInterpretationData>
			{
	...
	public static SignData CreateVacatSign(float width = 5, float? probability = null) => new()
	{
			SignInterpretations = new List<SignInterpretationData>
			{
	...
	public static SignData CreateDamageSign(float width = 1, float? probability = null) => new()
	{
			SignInterpretations = new List<SignInterpretationData>
			{
	...
	public static SignData CreateTerminatorSign(
			...
			, TableData.TerminatorType terminatorType) => new()
	{
			SignInterpretations = new List<SignInterpretationData>
			{
