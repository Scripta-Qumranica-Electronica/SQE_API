...
public class SignInterpretationData
{
	...
	public List<uint> SignStreamSectionIds                 { get; set; } = new();

	public List<uint> QwbWordIds { get; set; } = new();

	public List<SignInterpretationAttributeData> Attributes { get; set; } = new();

	public List<SignInterpretationCommentaryData> Commentaries { get; set; } = new();

	// NOTE Ingo changed the collection of nextSignInterpretationIds from hashset to list
	public List<NextSignInterpretation> NextSignInterpretations { get; set; } = new();

	public List<SignInterpretationRoiData> SignInterpretationRois { get; set; } = new();
