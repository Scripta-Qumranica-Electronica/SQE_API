...
AS (
	...
	FROM position_in_stream
		...
		JOIN edition_editor AS sign_sequence_author 
			ON position_in_stream_owner.edition_editor_id = sign_sequence_author.edition_editor_id

		JOIN sign_interpretation ON sign_interpretation.sign_interpretation_id = position_in_stream.sign_interpretation_id
		...
		JOIN edition_editor AS manuscript_author 
			ON manuscript_data_owner.edition_editor_id = manuscript_author.edition_editor_id

		LEFT JOIN sign_interpretation_roi 
			ON sign_interpretation_roi.sign_interpretation_id = sign_interpretation.sign_interpretation_id
	...
	FROM sign_interpretation_ids		  
		JOIN position_in_stream ON position_in_stream.sign_interpretation_id = nextSignInterpretationId
			AND position_in_stream.sign_interpretation_id != @EndId
		JOIN position_in_stream_owner 
			ON position_in_stream_owner.position_in_stream_id = position_in_stream.position_in_stream_id
				AND position_in_stream_owner.edition_id = @EditionId
		JOIN edition_editor AS sign_sequence_author 
		...
		JOIN sign_interpretation 
			ON sign_interpretation.sign_interpretation_id = nextSignInterpretationId
		JOIN sign_interpretation_attribute ON sign_interpretation_attribute.sign_interpretation_id=nextSignInterpretationId
		LEFT JOIN attribute_numeric USING (sign_interpretation_attribute_id)
		JOIN sign_interpretation_attribute_owner 
			ON sign_interpretation_attribute_owner.sign_interpretation_attribute_id = sign_interpretation_attribute.sign_interpretation_attribute_id
				AND sign_interpretation_attribute_owner.edition_id = @EditionId
