...
SELECT DISTINCT text_fragment_data.text_fragment_id AS TextFragmentId, 
                ...
                artefact_data.name AS ArtefactName,
                artefact_position.scale AS ArtefactScale,
                artefact_position.rotate AS ArtefactRotate,
                artefact_position.translate_x AS ArtefactTranslateX,
                artefact_position.translate_y AS ArtefactTranslateY,
                artefact_position.z_index AS ArtefactZIndex,
...
JOIN sign_interpretation_roi_owner ON sign_interpretation_roi_owner.sign_interpretation_roi_id = sign_interpretation_roi.sign_interpretation_roi_id
    AND sign_interpretation_roi_owner.edition_id = line_to_sign_owner.edition_id
...
JOIN artefact_position_owner ON artefact_position_owner.artefact_position_id = artefact_position.artefact_position_id
    AND artefact_position_owner.edition_id = line_to_sign_owner.edition_id
...
JOIN artefact_data_owner ON artefact_data_owner.artefact_data_id = artefact_data.artefact_data_id
    AND artefact_data_owner.edition_id = line_to_sign_owner.edition_id
JOIN sign_interpretation_attribute ON sign_interpretation_attribute.sign_interpretation_id = sign_interpretation_roi.sign_interpretation_id
