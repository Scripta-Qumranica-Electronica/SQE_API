...
namespace sqe_realtime_hub_builder
{
	internal static class Program
	{
		...
		{
			var folder = $"{AppDomain.CurrentDomain.BaseDirectory}../../../../sqe-api-server/HttpControllers";
			...
			foreach(var file in files )
			{
				...
				using (var outputFile = new StreamWriter($"{projectRoot}/../sqe-api-server/RealtimeHubs/{controllerName}Hub.cs"))
				{
