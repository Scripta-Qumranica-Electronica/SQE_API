...
namespace SQE.SqeHttpApi.Server.Helpers
{
	public interface IArtefactService
	{
		...
		Task<ArtefactListDTO> GetEditionArtefactListingsAsync(uint? userId,
			uint editionId,
			bool withMask = false,
			bool withImages = false);

		Task<ArtefactListDTO> GetEditionArtefactListingsWithImagesAsync(uint? userId,
			uint editionId,
			bool withMask = false);

		Task<ArtefactDTO> UpdateArtefactAsync(UserInfo user,
			uint editionId,
			uint artefactId,
			string mask = null,
			string name = null,
		...
		Task<ArtefactDTO> CreateArtefactAsync(UserInfo user,
			uint editionId,
			uint masterImageId,
			string mask = null,
			string name = null,
	...
	public class ArtefactService : IArtefactService
	{
		...
		public async Task<ArtefactListDTO> GetEditionArtefactListingsAsync(uint? userId,
			uint editionId,
			bool withMask = false,
			bool withImages = false)
		{
		...
		public async Task<ArtefactListDTO> GetEditionArtefactListingsWithImagesAsync(uint? userId,
			uint editionId,
			bool withMask = false)
		{
		...
		public async Task<ArtefactDTO> UpdateArtefactAsync(UserInfo user,
			uint editionId,
			uint artefactId,
			string mask = null,
			string name = null,
		...
		public async Task<ArtefactDTO> CreateArtefactAsync(UserInfo user,
			uint editionId,
			uint masterImageId,
			string mask = null,
			string name = null,
