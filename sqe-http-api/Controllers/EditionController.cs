...
namespace SQE.SqeHttpApi.Server.Controllers
{
	...
	public class EditionController : ControllerBase
	{
		...
		[ProducesResponseType(404)]
		public async Task<ActionResult<EditionDTO>> UpdateEdition([FromBody] EditionUpdateRequestDTO request,
		...
		[ProducesResponseType(403)]
		[ProducesResponseType(404)]
		public async Task<ActionResult<EditionDTO>> CopyEdition([FromBody] EditionCopyDTO request,
			[FromRoute] uint editionId)
		{
		...
		public async Task<ActionResult<EditorRightsDTO>> AddEditionEditor([FromBody] EditorRightsDTO payload,
			[FromRoute] uint editionId)
		{
		...
		public async Task<ActionResult<EditorRightsDTO>> AlterEditionEditor([FromBody] EditorRightsDTO payload,
			[FromRoute] uint editionId)
		{
