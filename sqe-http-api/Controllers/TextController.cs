...
namespace SQE.SqeHttpApi.Server.Controllers
{
	...
	public class TextController : ControllerBase
	{
		...
		/// <returns>
		///     A scroll object with includes the fragments and their lines
		///     in a hierarchical order and in correct sequence
		/// </returns>
		[AllowAnonymous]
		...
		/// <param name="editionId">Id of the edition</param>
		/// <returns>
		///     A scroll object with includes the textFragmentName and its lines
		///     in a hierarchical order and in correct sequence
		/// </returns>
		[AllowAnonymous]
