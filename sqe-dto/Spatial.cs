...
namespace SQE.API.DTO
{
    ...
    {
        [Required] public List<CharacterShapeDTO> letters { get; set; }
    }

    public class EditionScriptLinesDTO
    {
        [Required] public List<ScriptTextFragmentDTO> textFragments { get; set; }
    }

    public class CharacterShapeDTO
    {
        [Required] public uint id { get; set; }
        [Required] public char character { get; set; }
        [Required] public string polygon { get; set; }
    ...
    public class ScriptTextFragmentDTO
    {
        ...
        [Required] public List<ScriptLineDTO> lines { get; set; }
    }
    ...
    public class ScriptLineDTO
    {
        ...
        [Required] public List<ScriptArtefactCharactersDTO> artefacts { get; set; }
    }

    public class ScriptArtefactCharactersDTO
    {
        [Required] public string artefactName { get; set; }
        [Required] public uint artefactId { get; set; }
        [Required] public PlacementDTO placement { get; set; }
        [Required] public List<SignInterpretationDTO> characters { get; set; }
    }
}