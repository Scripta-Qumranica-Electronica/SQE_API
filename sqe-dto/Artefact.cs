...
namespace SQE.API.DTO
{
    ...
    public class ArtefactDTO : ArtefactDataDTO
    {
        ...
        [Required] public uint imageId { get; set; }

        [Required] public uint artefactDataEditorId { get; set; }

        [Required] public string mask { get; set; }

        [Required] public uint artefactMaskEditorId { get; set; }

        [Required] public bool isPlaced { get; set; }
    ...
    {
        [Required] public List<UpdateArtefactPlacementDTO> artefactPlacements { get; set; }
    }

    public class UpdatedArtefactPlacementDTO : UpdateArtefactPlacementDTO
    {
        [Required] public uint placementEditorId { get; set; }
    }
