...
namespace SQE.API.DTO
{
    ...
    public class CatalogueMatchInputDTO
    {
        ...
        [Required] public string imagedObjectId { get; set; }
        [Required] public uint manuscriptId { get; set; }
        [Required] public string editionName { get; set; }
        [Required] public string editionVolume { get; set; }
        [Required] public string editionLocation1 { get; set; }
        [Required] public string editionLocation2 { get; set; }
    ...
    {
        [Required] public uint imageCatalogId { get; set; }
        [Required] public string institution { get; set; }
        [Required] public string catalogueNumber1 { get; set; }
        ...
        [Required] public uint iaaEditionCatalogueId { get; set; }
        [Required] public string manuscriptName { get; set; }
        [Required] public string name { get; set; }
        [Required] public string matchAuthor { get; set; }
        public string matchConfirmationAuthor { get; set; }
        [Required] public uint matchId { get; set; }
        [Required] public DateTime dateOfMatch { get; set; }
        public DateTime? dateOfConfirmation { get; set; }
    }

    public class CatalogueMatchListDTO
    {
        [Required] public CatalogueMatchDTO[] matches { get; set; }
    }
}